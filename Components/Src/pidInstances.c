...
static PID_HandleTypeDef pid_instances[PID_INST_AMOUNT];  // Instances
...
void mainHotEnd_initInstance() {
  ...
  pid_instances[MainHotEnd].fb.getValue = &tempSensorsGet;
...
void PidIterate(PID_instance instance) {
  osDelay(1000/pid_instances[instance].config.CALL_frq);
